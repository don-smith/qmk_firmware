 ...
 */
[_I3] = {
  {M(28),   M(1),    M(2),    M(3),    M(4),    M(5),    M(6),    M(7),    M(8),    M(9),    M(10),   M(0)},
  {_______, M(11),   M(12),   M(13),   M(14),   M(15),   M(16),   M(17),   M(18),   M(19),   M(20),   ______},
  {_______, M(21),   M(22),   M(23),   M(24),   M(25),   M(26),   M(27),   _______, _______, _______, ______},
...
const macro_t *action_get_macro (keyrecord_t *record, uint8_t id, uint8_t opt)
{
    ...
    switch (id) {
        ...
        case 28:
            return MACRO( D(LALT), D(LSFT), T(Q), U(LSFT), U(LALT), END );
    }
    return MACRO_NONE;
}
